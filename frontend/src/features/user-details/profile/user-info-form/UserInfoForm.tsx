...
export function UserInfoForm( { user }: {user: IUser} ) {
        ...
        <form className={ `row ${styles.userInfoForm}` } onSubmit = { saveChanges } >           
                ...
                <div className = "col-9">
                    ...
                    <div className="input input--fluid">
                        <input type="text" name="firstname" id="firstname" value={ userInfo.firstname } onChange = { (e: ChangeEvent<HTMLInputElement>) => { onChange('firstname', e.target.value) } }/>
                    </div>
                </div>
                ...
                <div className = "col-9">
                    ...
                    <div className="input input--fluid">
                        <input type="text" name="lastname" id="lastname" value={ userInfo.lastname } onChange = { (e: ChangeEvent<HTMLInputElement>) => { onChange('lastname', e.target.value) } } />
                    </div>
                </div>
                ...
                <div className = "col-9">
                    ...
                    <div className="input input--fluid">
                        <input type="text" name="headline" id="headline" value={ userInfo.headline } onChange = { (e: ChangeEvent<HTMLInputElement>) => { onChange('headline', e.target.value) } }/>
                    </div>
                </div>
